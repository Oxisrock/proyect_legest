...
const UserSchema = new Schema({
  ...
  password: {type: 'String', required: 'Password is obligatory', minlength: [7, 'Password must be greater than 7 characters'], validate: password_validation}, //   contraseña con la cual el usuario se registrara
  ...
  email: { type: 'String', unique: true, lowercase: true, required: 'Email is obligatory', match: email_match }, // correo con el usuario se registro total mente obligario y tiene que ser unico
